...
Het is altijd moeilijk de eerste keer dat je iets doet. Zeker wanneer je samen werkt kan het maken van fouten erg vervelend zijn. Maar in open-source ontkom je er niet aan. We willen het graag eenvoudiger maken om te leren en bij te dragen voor de eerste keer aan een open-source project.
